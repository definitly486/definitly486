...
cd $HOME
curl -L -o $TERMUX_PREFIX/tmp/main.tar.gz https://github.com/definitly486/Lenovo_Tab_3_7_TB3-730X/archive/main.tar.gz
tar -xf $TERMUX_PREFIX/tmp/main.tar.gz -С $HOME
